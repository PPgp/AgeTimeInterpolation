########################################################################
## Interpolation of event data (five year periods) 
...
## Implementation by Thomas Buettner (22 Oct. 2015)
########################################################################

BeersMSplit <- function(tp) {
# tp = input dataset

## interpolation period

## dimensions
NCOL <- dim(tp)[2]   ## trajectories in columns
NAG5 <- dim(tp)[1]   ## age or time in rows
